package br.com.cleberb.tasks.repository;
...
public class TaskCustomRepository {
    ...
    //realizaremos operações de forma manual
    ...
    //método que retorna uma page task
    public Page<Task> findPaginated(Task task, Integer page, Integer size){
        Pageable pageable = PageRequest.of(page, size, Sort.by("title").ascending());

        //Criar um exemplo de base, ignorando as combinações abaixo
        ...
        //precisamos informar o que faremos com os atributos caso sejam válidos
